...
class ratings {
    ...
    var $data_file = './ratings.data.txt';		// address of file containing the rating data
    private $widget_id;
    private $data = array();
    
    
function __construct($wid) {					// The constructor extracts the data out of the stored file
