<?php
$title="Shoe Bag at golfessentials.in";
include 'header.php'; ?>
          ...
          <div id="products">
               <div class="customize">
                    ...
                    <div id="content" class="alpha grid_10 omega">
                         <div>
                              <a href="JStewart/custom/shoe%20bag/1.jpg" class="jqzoom left" rel='gal2'  title=" " >
                                   <img src="JStewart/custom/shoe%20bag/1_small.jpg"  title=" ">
                              </a>
                         </div>
                         <div>
                              <ul id="thumblist">
                                   <li>
                                        <a class="zoomThumbActive" href='javascript:void(0);' rel="{gallery: 'gal2', smallimage: 'JStewart/custom/shoe%20bag/1_small.jpg',largeimage: 'JStewart/custom/shoe%20bag/1.jpg'}">
                                             <img src='JStewart/custom/shoe%20bag/1_thumb.jpg'>
                                        </a>
                                   </li>
                              </ul>
                         </div>
                    ...
                    <div class="alpha grid_14 omega details">
                         <p><b>Size</b> : 31cm x 24cm x 16cm</p>
                         ...
                         <ul>
                              <b>Extra Features:</b>
                              <li>-&nbsp;Large interior compartment to fit all sizes of shoes</li>
                              <li>-&nbsp;Two exterior zipped pockets, ideal for socks etc.</li>
                         </ul>
                    </div>
                    ...
                    <div class="placement">
                         ...
                         <h5>Step 2. Select the colours and personalised embroideries of your choice, and their placement, on the product. Please remember to upload the highest resolution file possible of the logos to ensure optimum quality output. EPS/open files, high resolution PDF files are preferred. The above mentioned price includes 2 personalised embroideries that would comprise of Name, Country Name, Logo and/or Website URL, which can be used in the combination of your choice. The maximum number of embroderies possible on this product is 2.</h5>
                         <h5>Step 3. Submit your order and wait to hear from us!</h5>
                         <h3>Color Guide</h3>
                         <hr>
                         <img src="JStewart/custom/colour.jpg"><br>
                         <img src="JStewart/custom/shoe%20bag/colorplacement.jpg">
                         <br>
                         <h3>Logo Placement</h3>
                         <hr>
                         <img src="JStewart/custom/shoe%20bag/logoplacement.jpg">
                         <br>
                         <h3>Colour Chart</h3>
                         <hr>
                         ...
                         <hr>
                         <form action="customiseprocessing.php" method="POST" enctype="multipart/form-data" name="shoe" id="customiseform">
                              <table>
                                   <tr>
