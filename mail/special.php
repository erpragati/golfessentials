		...
		<tr>
			<td>
				<table width="600" cellpadding="0" cellspacing="0" align="center" valign="top">
					...
					<tr><td colspan="3" height="10"><img src="http://golfessentials.in/img/curve.png" width="600" height="10"></td></tr>
					<tr style="background-color:#fff;">
						<td width="300" align="center" valign="middle" colspan="3" style="background-color:#fff;">
							<a href="http://golfessentials.in"><img src="http://golfessentials.in/img/logo_BW.png" width="300" height="54" /></a>
						</td>
					</tr>
					<tr style="background-color:#ccc;"><td height="1" colspan="3"  style="background-color:#ccc;"></td></tr>
					<tr style="background-color:#fff;"><td height="30" colspan="3"  style="background-color:#fff;"></td></tr>
					<tr style="background-color:#fff;font-size:16px;font-family:'arial','sans-serif';color:#333;">
						...
						<td width="560" align="left" valign="middle" style="background-color:#fff;">
							...
							<p>If you have any questions or comments, we encourage you to <a href="http://golfessentials.in/contactus">contact us</a>.</p>
