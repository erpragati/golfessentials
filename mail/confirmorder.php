				...
				<table width="600" cellpadding="0" cellspacing="0" align="center" valign="top">
					...
					<tr style="background-color:#fff;font-size:16px;font-family:'arial','sans-serif';color:#333;">
						...
						<td width="560" align="left" valign="middle">
							<p style="font-size:16px;">Hi XYZ,</p>
							...
							<p style="font-size:16px;">On receipt of payment, the package will be dispatched and the tracking details will be sent across to you (not applicable in the case of cash on delivery).</p>
