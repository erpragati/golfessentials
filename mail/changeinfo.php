				...
				<table width="600" cellpadding="0" cellspacing="0" align="center" valign="top">
					...
					<tr style="background-color:#fff;font-size:16px;font-family:'arial','sans-serif';color:#333;">
						...
						<td width="560" align="left" valign="middle">
							...
							<p>The following information for your golfessentials.in account <?php echo GetCustomerDetails('email'); ?> was updated on <?php echo date('l jS \of F Y h:i A'); ?></p>
							<p>
								<?php
							...
							<p>If these changes were made in error, or if you believe an unauthorised person accessed your account, please reset your account password immediately by clicking <a href="http://golfessentials.in/pwdchange">here</a>.</p>
							<p>If you have any concerns, we encourage you to <a href="http://golfessentials.in/contactus">contact us</a>.</p>
