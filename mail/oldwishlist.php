				...
				<table width="600" cellpadding="0" cellspacing="0" align="center" valign="top">
					...
					<tr style="background-color:#fff;font-size:16px;font-family:'arial','sans-serif';color:#333;">
						...
						<td width="560" align="left" valign="middle">
							<p>Hi XYZ,</p>
							<p>We noticed that the following items have been in your wishlist for a while:</p>
							<p>Just wanted to check if you would like to purchase(linked to wishlist) them now or leave them in your wishlist for another day!</p>
