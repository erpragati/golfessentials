				...
				<table width="600" cellpadding="0" cellspacing="0" align="center" valign="top">
					...
					<tr style="background-color:#fff;font-size:16px;font-family:'arial','sans-serif';color:#333;">
						...
						<td width="560" align="left" valign="middle">
							...
							<p>We received a request to reset your password for your golfessentials.in account <?php echo GetCustomerDetails('email'); ?></p>
							<p>Click <a href="http://golfessentials.in/changepwd?e=<?php echo $email;?>&amp;b=<?php echo $hash;?>">here</a> to reset your password.</p>
							<p>Please ignore this message if you do not wish to reset your password. Your password will not be reset. If you have any concerns, we encourage you to <a href="http://golfessentials.in/contactus">contact us</a>.</p>
