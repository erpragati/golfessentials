				...
				<table width="600" cellpadding="0" cellspacing="0" align="center" valign="top">
					...
					<tr style="background-color:#fff;">
						...
						<td width="560" align="left" valign="middle">
							<p><b><?php echo $uname; ?></b> requested that we send this email. If you have any questions or comments, we encourage you to <a href="http://golfessentials.in/contactus">contact us</a>.</p>
							<p><b>Please follow the link below to check out the product <?php echo $uname; ?> thought you would like:</b></p>
