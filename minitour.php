<?php 
$title="Premium Mini Tour Bag at golfessentials.in";
include 'header.php'; ?>
  <div role="main" class="container_24">
          ...
          <div id="products">
               <div class="customize">
                    <h2>Premium Mini Tour Bag</h2>
                    <hr>
                    <div id="content" class="alpha grid_10 omega">
                         <div>
                              <a href="JStewart/custom/mini tour bag/1.jpg" class="jqzoom left" rel='gal2'  title=" " >
                                   <img src="JStewart/custom/mini tour bag/1_small.jpg"  title=" ">
                              </a>
                         </div>
                         <div>
                              <ul id="thumblist">
                                   <li>
                                        <a class="zoomThumbActive" href='javascript:void(0);' rel="{gallery: 'gal2', smallimage: 'JStewart/custom/mini tour bag/1_small.jpg',largeimage: 'JStewart/custom/mini tour bag/1.jpg'}">
                                             <img src='JStewart/custom/mini tour bag/1_thumb.jpg'>
                                        </a>
                                   </li>
                                   <li>
                                        <a href='javascript:void(0);' rel="{gallery: 'gal2', smallimage: 'JStewart/custom/mini tour bag/2_small.jpg',largeimage: 'JStewart/custom/mini tour bag/2.jpg'}">
                                             <img src='JStewart/custom/mini tour bag/2_thumb.jpg'>
                                        </a>
                                   </li>
                                   <li>
                                        <a href='javascript:void(0);' rel="{gallery: 'gal2', smallimage: 'JStewart/custom/mini tour bag/3_small.jpg',largeimage: 'JStewart/custom/mini tour bag/3.jpg'}">
                                             <img src='JStewart/custom/mini tour bag/3_thumb.jpg'>
                                        </a>
                                   </li>
                                   <li>
                                        <a href='javascript:void(0);' rel="{gallery: 'gal2', smallimage: 'JStewart/custom/mini tour bag/4_small.jpg',largeimage: 'JStewart/custom/mini tour bag/4.jpg'}">
                                             <img src='JStewart/custom/mini tour bag/4_thumb.jpg'>
                                        </a>
                                   </li>
                              </ul>
                         </div>
                    ...
                    <div class="alpha grid_14 omega details">
                         ...
                         <p><b>Top Configuration</b> : 5 Sections</p>
                         <p><b>Construction</b> : Tube</p>
                         <p><b>Number of Pockets</b> : 6</p>
                         <p><b>Hood</b> : Yes ( Zipper )</p>
                         <p><b>Strap</b> : Single</p>
                         <p><b>Weight</b> : approx 5.5 kg</p>
                         ...
                         <p><b>Production Lead Time</b> : 30-45 days</p>
                         <p class="green"><b>Price</b> : <b class="ruppeefont">`</b> 29,650</p>
                         <ul>
                              <b>Extra Features:</b>
                              <li>-&nbsp;Firm indented side panels</li>
                              <li>-&nbsp;Detachable front pocket, so that embroidery can be added at a later time.</li>
                         </ul>
                         <p><b>Note</b> : ONLY black or white fabric can be used for the side panels</p>
                         <img src="JStewart/custom/mini tour bag/top.jpg">
                    </div>
                    ...
                    <div class="placement">
                         ...
                         <hr>
                         <form action="customiseprocessing.php" method="POST" enctype="multipart/form-data" id="customiseform" name="minitour">
                              <table>
                                   <tr>
                                   ...
                                   <tr>
                                        <td class="borderbottom">
                                             <select name="nameposition">
                                                  <option value="<?php if(isset($_SESSION['nameposition'])){echo $_SESSION['nameposition'];} else {echo "0";} ?>" selected="selected"><?php if(isset($_SESSION['nameposition'])&&$_SESSION['nameposition']!='0'){echo "Position #".$_SESSION['nameposition'];}else{echo "None";} ?></option>
                                   ...
                                   <tr>
                                        <td class="borderbottom">
                                             <select name="flagposition">
                                                  <option value="<?php if(isset($_SESSION['flagposition'])){echo $_SESSION['flagposition'];} else {echo "0";} ?>" selected="selected"><?php if(isset($_SESSION['flagposition'])&&$_SESSION['flagposition']!='0'){echo "Position #".$_SESSION['flagposition'];}else{echo "None";} ?></option>
                                                  <option value="1">Position #1</option>
                                                  <option value="2">Position #2</option>
                                                  <option value="3">Position #3</option>
                                                  <option value="4">Position #4</option>
                                        ...
                                        <td class="borderbottom">
                                             <select name="urlposition">
                                                  <option value="<?php if(isset($_SESSION['urlposition'])){echo $_SESSION['urlposition'];} else {echo "0";} ?>" selected="selected"><?php if(isset($_SESSION['urlposition'])&&$_SESSION['urlposition']!='0'){echo "Position #".$_SESSION['urlposition'];}else{echo "None";} ?></option>
                                                  <option value="1">Position #1</option>
                                                  <option value="2">Position #2</option>
                                                  <option value="3">Position #3</option>
                                                  <option value="4">Position #4</option>
                                   ...
                                   <tr>
                                        ...
                                        <td>
                                             Yes&nbsp;<input type="radio" name="logo2" <?php if (isset($_SESSION['logo2b'])) { echo "checked=\"checked\""; } ?> value="yes">
                                             &nbsp;
                                   ...
                                   <tr height="20"><td colspan="2"><span class="requiredField">*</span> Fields marked with <span class="requiredField">*</span> are required.</td></tr>
                              </table>
                              <?php
                                   function del($name){
                              ...
                              <input type="hidden" name="productname" value="Premium Mini Tour Bag">
                              <input type="hidden" name="baseprice" value="29650">
                              <input type="hidden" name="leadtime" value="30-45 days">
                              <input type="hidden" name="page" value="minitour">
