<?php 
$title="Pro Staff Bag at golfessentials.in";
include 'header.php'; ?>
          ...
          <div id="products">
               <div class="customize">
                    ...
                    <div id="content" class="alpha grid_10 omega">
                         <div>
                              <a href="JStewart/custom/pro%20staff/1.jpg" class="jqzoom left" rel='gal2'  title=" " >
                                   <img src="JStewart/custom/pro%20staff/1_small.jpg"  title=" ">
                              </a>
                         </div>
                         <div>
                              <ul id="thumblist">
                                   <li>
                                        <a class="zoomThumbActive" href='javascript:void(0);' rel="{gallery: 'gal2', smallimage: 'JStewart/custom/pro%20staff/1_small.jpg',largeimage: 'JStewart/custom/pro%20staff/1.jpg'}">
                                             <img src='JStewart/custom/pro%20staff/1_thumb.jpg'>
                                        </a>
                                   </li>
                                   <li>
                                        <a href='javascript:void(0);' rel="{gallery: 'gal2', smallimage: 'JStewart/custom/pro%20staff/2_small.jpg',largeimage: 'JStewart/custom/pro%20staff/2.jpg'}">
                                             <img src='JStewart/custom/pro%20staff/2_thumb.jpg'>
                                        </a>
                                   </li>
                                   <li>
                                        <a href='javascript:void(0);' rel="{gallery: 'gal2', smallimage: 'JStewart/custom/pro%20staff/3_small.jpg',largeimage: 'JStewart/custom/pro%20staff/3.jpg'}">
                                             <img src='JStewart/custom/pro%20staff/3_thumb.jpg'>
                                        </a>
                                   </li>
                              </ul>
                         </div>
                    ...
                    <div class="alpha grid_14 omega details">
                         ...
                         <p><b>Number of Pockets</b> : 4</p>
                         <p><b>Hood</b> : Yes ( Zipper )</p>
                         <p><b>Strap</b> : Single</p>
                         <p><b>Webbing</b> : Black/White</p>
                         ...
                         <img src="JStewart/custom/pro staff/top.jpg">
                    </div>
                    ...
                    <div class="placement">
                         ...
                         <hr>
                         <form action="customiseprocessing.php" method="POST" enctype="multipart/form-data" name="staff" id="customiseform">
                              <table>
                                   <tr>
                                   ...
                                   <tr><td class="green">Logo #7</td><td class="green">Quantity <span class="requiredField">*</span></td></tr>
                                   <tr>
                                        <td>
                                   ...
                                   <tr><td>Logo #7 Position</td><td></td></tr>
                                   <tr>
                                        <td class="borderbottom">
                              ...
                              <input type="hidden" name="productname" value="Staff Bag">
