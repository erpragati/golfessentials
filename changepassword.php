          ...
          <div id="products">
               <div class="account">
                    <div class="changedetails">
                         ...
                         <p>Your password must be between 6 and 12 characters, preferably alphanumeric</p>
                         <form action="changeinfo.php" method="POST">
                              <table>
                                   <tr>
                                        <td>Old Password</td>
                                        <td><input type="password" name="oldpwd" tabindex="1"></td>
                                   </tr>
                                   <tr>
                                        <td>New Password</td>
                                        <td><input type="password"name="newpwd" tabindex="2"></td>
                                   </tr>
                                   <tr>
                                        <td>Re-enter New Password</td>
                                        <td><input type="password"name="repeatpwd" tabindex="3"></td>
                                   </tr>
                                   <tr>
